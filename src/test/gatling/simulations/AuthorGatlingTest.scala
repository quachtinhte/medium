...
class AuthorGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Author entity")
        ...
        .repeat(2) {
            ...
            .post("/api/authors")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "password":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "birthday":"2020-01-01T00:00:00.000Z", "urlAvatar":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
